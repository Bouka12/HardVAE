...
C_METRICS = [c.f1, c.f1v, c.f2, c.f3, c.f4, c.l1, c.l2, c.l3, c.n1, c.n2, c.n3, c.n4,
             c.t1, c.lsc, c.density, c.clsCoef, c.hubs, c.t2, c.t3, c.t4 ]
C_COLORS = ['#FD0100', '#F76915', '#EEDE04', '#A0D636', '#2FA236']
C_RANGES = {'FB': 5, 'LR': 3, 'NB': 6,
            'NE': 3, 'DM': 3}
C_WEIGHTS = np.ones((20))
...
class ComplexityCalculator:
    ...
    def plot(self, figure, spec=(1,1,1)):
        ...
        """
        print(f"self.complexity: {self.complexity}")
